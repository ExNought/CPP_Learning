========================================================================
    KONSOLENANWENDUNG: StandardTypetesting-Projektübersicht
========================================================================

Diese StandardTypetesting-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre StandardTypetesting-Anwendung besteht.


StandardTypetesting.vcxproj
...
StandardTypetesting.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen StandardTypetesting.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
