========================================================================
    KONSOLENANWENDUNG: User-Defined Types-Projektübersicht
========================================================================

Diese User-Defined Types-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre User-Defined Types-Anwendung besteht.


User-Defined Types.vcxproj
...
User-Defined Types.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen User-Defined Types.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
